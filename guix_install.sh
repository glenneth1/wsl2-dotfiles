...
# Copyright Â© 2017 sharlatan <sharlatanus@gmail.com>
# Copyright Â© 2018 Ricardo Wurmus <rekado@elephly.net>
# Copyright Â© 2018 Efraim Flashner <efraim@flashner.co.il>
# Copyright Â© 2019â€“2020, 2022 Tobias Geerinckx-Rice <me@tobias.gr>
# Copyright Â© 2020 Morgan Smith <Morgan.J.Smith@outlook.com>
# Copyright Â© 2020 Simon Tournier <zimon.toutoune@gmail.com>
# Copyright Â© 2020 Daniel Brooks <db48x@db48x.net>
# Copyright Â© 2021 Jakub KÄ…dzioÅ‚ka <kuba@kadziolka.net>
# Copyright Â© 2021 Chris Marusich <cmmarusich@gmail.com>
# Copyright Â© 2021, 2022, 2023 Maxim Cournoyer <maxim@guixotic.coop>
# Copyright Â© 2022 Prafulla Giri <prafulla.giri@protonmail.com>
# Copyright Â© 2023 Andrew Tropin <andrew@trop.in>
# Copyright Â© 2020 David A. Redick <david.a.redick@gmail.com>
# Copyright Â© 2024 Janneke Nieuwenhuizen <janneke@gnu.org>
# Copyright Â© 2024 Tomas Volf <~@wolfsden.cz>
...
Would you like me to fetch it for you?"; then
            ...
            # â€˜freezesâ€™ when Savannah goes out to lunch, as has happened.
...
{ # Unpack and install /gnu/store and /var/guix
    ...
    # Strip (skip) the leading â€˜.â€™ component, which fails on read-only â€˜/â€™.
    #
    # TODO: Eventually extract with â€˜--owner=guix-daemonâ€™ when installing
    ...
    # and a new release that does, so â€˜chown -Râ€™ later if needed.
...
{ # Create the group and user accounts for build users.
	...
	# â€˜tar xfâ€™ creates root:root files.  Change that.
...
if [ -L "$GUIX_PROFILE" ]; then
  ...
  # the user installs info and man readers via Guix.  If the user doesnâ€™t,
  # explicitly add to them so documentation for software from â€˜guix installâ€™
...
EOF
    ...
    # Don't use â€˜read -pâ€™ here!  It won't display when run non-interactively.
